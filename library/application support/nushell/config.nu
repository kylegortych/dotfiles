...
# run nu as sub shell then 
# run env | each { |it| echo $"let-env ($it.name) = '($it.raw)'" } | str collect (char nl)
# add env PATHS to config.nu

let-env CMD_DURATION_MS = ''
let-env COLORFGBG = ''
let-env COLORTERM = 'truecolor'
let-env COMMAND_MODE = ''
let-env ENV_CONVERSIONS = ''
let-env HOME = ''
let-env ITERM_PROFILE = 'Profile 1'
let-env ITERM_SESSION_ID = ''
let-env LANG = 'en_US.UTF-8'
let-env LAST_EXIT_CODE = '0'
let-env LC_TERMINAL = 'iTerm2'
let-env LC_TERMINAL_VERSION = ''
let-env LOGNAME = ''
let-env NU_LIB_DIRS = ''
...
let-env PWD = '/Users/kylegortych'
let-env SHELL = ''
let-env SHLVL = '1'
let-env SSH_AUTH_SOCK = ''
let-env STARSHIP_SESSION_KEY = ''
let-env STARSHIP_SHELL = ''
let-env TERM = ''
let-env TERM_PROGRAM = ''
let-env TERM_PROGRAM_VERSION = ''
let-env TERM_SESSION_ID = ''
let-env TMPDIR = ''
let-env USER = 'kylegortych'
let-env XPC_FLAGS = ''
let-env XPC_SERVICE_NAME = ''
let-env __CFBundleIdentifier = ''
let-env __CF_USER_TEXT_ENCODING = ''
...
# alias kotlin-run-script = kotlinc $argv -include-runtime -d $argv && java -jar $argv
